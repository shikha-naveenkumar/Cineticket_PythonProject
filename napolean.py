...
def nap():
    ...
    win_label= Label(parent, text= "DESCRIPTION : An epic that details the checkered rise and fall of French Emperor Napoleon Bonaparte and his relentless ", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "journey to power through the prism of his addictive, volatile relationship with his wife, Josephine.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Cast: Joaquin PhoenixVanessa KirbyTahar Rahim", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Director: Ridley Scott", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Producer: Jimmy Abounouom", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Co-Producer: Raymond Kirk", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    win_label= Label(parent, text= "Director Of Photography: Dariusz Wolski", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=710)
    win_label= Label(parent, text= "Music: Martin Phipps", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=730)
    ...
    image1 = Image.open("napmain.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=25, y=110) 
    ############################################################################
    parent.mainloop()
def ticket():
    root=tk.Toplevel()
