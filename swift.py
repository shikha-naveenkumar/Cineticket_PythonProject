...
def swift():
    ...
    parent = tk.Toplevel()
    parent.title("Taylor Swift: The Eras Tour")
    ...
    ##########################
    image1 = Image.open("era_poster.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=300, y=110)    
    ###########################################################################
    #to make movie content
    win_label= Label(parent, text= "DESCRIPTION :The cultural phenomenon continues on the big screen! Immerse yourself in this ", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "once-in-a-lifetime concert film experience with a breathtaking, cinematic view of the history-making tour.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Cast: Taylor Swift, amos heller, paul sidoti", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Director:Sam Wrench", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Production: Taylor Swift Productions,Silent House", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "crew:Taylor Swift, amos heller, paul sidoti,sam wrench", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
