...
def update():
    ...
    Button(root1,width=39,height=2,text='Check',bg='#57a1f8',fg='white',border=0,command=check).place(x=560,y=200)
    ...
    Button(root1,width=39,height=2,text='Sign up',bg='#57a1f8',fg='white',border=0,command=register_user2).place(x=560,y=300)
