...
def japan():
    ...
    win_label= Label(parent, text= "DESCRIPTION : A daring robbery in a jewellery showroom kickstarts the hunt for Japan,", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=470)
    win_label= Label(parent, text= "a notorious robber, who is a law unto himself.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Karthi, Sunil, K.S Ravikumar", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Raju Murugan", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Aravendraj", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Co-Producer: Bhaskaran", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Screenplay: S.R. Prabhu", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Sathyan Sooryan", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: G.V. Prakash Kumar	", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    ###########################333
    image1 = Image.open("japanmain.jpg")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=100, y=90) 
    ############################################################################
    parent.mainloop()
def ticket():
    root=tk.Toplevel()
