...
def tgrmv():
    ...
    win_label= Label(parent, text= "DESCRIPTION : Tiger and Zoya are back - to save the country and their family. This time it’s personal!", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Salman Khan, Katrina Kaif, Emraan Hashmi", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Maneesh Sharma", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Aditya Chopra", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Co-Producer: Akshaye Widhani", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Screenplay: Shridhar Raghavan", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Anay Goswamy", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: Pritam", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    image1 = Image.open("tigermain.png")
...
def ticket():
    ...
    ####this code is for availability while screen opens
    ...
    cphone_txt=Entry(F1,width=15,font='arial 15 bold',state='normal',textvariable=c_phone,relief=SUNKEN,bd=7)
