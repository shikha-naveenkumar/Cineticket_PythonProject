...
def wish():
    ...
    win_label= Label(parent, text= "DESCRIPTION : A young girl named Asha wishes on a star and gets a more direct answer", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=470)
    win_label= Label(parent, text= "than she bargained for when a trouble-making star comes down from the sky to join her.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Ariana De Bose. Chris Pine . Alan Tudyk", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Chris Buck & Fawn Veerasunthorn", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Jennifer Lee", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    win_label= Label(parent, text= "Screenplay: Jennifer Lee", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Jeff Draheim", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: Dave Metzger", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    image1 = Image.open("wishmain.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=10, y=110) 
    ############################################################################
    parent.mainloop()
def ticket():
    root=tk.Toplevel()
