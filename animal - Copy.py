...
def animal():
    ...
    win_label= Label(parent, text= "DESCRIPTION : A father, who is often away due to work, is unable to comprehend the intensity of his son's love.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Ranbir Kapoor ,Anil Kapoor ,Bobby Deol", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Sandeep Reddy Vanga", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Shiv Chanana", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Co-Producer: Shiv Kumar Tiwari", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Screenplay: Max Rahman", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Ravichandran", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: Manan Bhardwaj", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    image1 = Image.open("animalmain.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=330, y=110) 
    ############################################################################
    parent.mainloop()
def ticket():
    root=tk.Toplevel()
