...
def dunki():
    ...
    win_label= Label(parent, text= "DESCRIPTION : Four friends from a village in Punjab share a common dream: to go to England.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Shah Rukh Khan, Taapsee Pannu, Boman Irani", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Rajkumar Hirani", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Syed Zaid Ali", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Co-Producer: Gauri Khan", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Screenplay: C.K. Muraleedharan", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Amit Roy", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: Pritam Chakraborty	", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    image1 = Image.open("dunkimain.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)
    # Position image
    label1s.place(x=200, y=110) 
    ############################################################################
    parent.mainloop()
def ticket():
    root=tk.Toplevel()
